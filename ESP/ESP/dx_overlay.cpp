...
namespace forceinline {
	...
	*/
	dx_overlay::dx_overlay(std::wstring target_class, std::wstring target_window, bool not_topmost) {
	...
	void dx_overlay::create_overlay(std::wstring target_class, std::wstring target_window) {
		WNDCLASSEX wc;
		wc.cbSize = sizeof(wc);
